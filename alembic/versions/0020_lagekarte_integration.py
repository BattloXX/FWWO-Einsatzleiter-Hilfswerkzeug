...
MariaDB auf diesem Server errno 150 wirft (Typ-/Charset-Mismatch zwischen
den referenzierten PKs und unseren FK-Spalten). Die referentielle Integrität
wird durch den SQLAlchemy-ORM sichergestellt.
"""
...
def upgrade() -> None:
    ...
    if not _table_exists("lagekarte_token"):
        # Ohne FK-Constraints: MariaDB errno 150 umgehen.
